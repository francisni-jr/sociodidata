...
export type NamedColors = 'blue' | 'azure' | 'indigo' | 'purple' | 'pink' | 'red' | 'orange' | 'yellow' | 'lime' | 'green' | 'teal' | 'cyan';
export type SocialMediaColors = 'facebook' | 'twitter' | 'google' | 'youtube' | 'vimeo' | 'dribbble' | 'github' | 'instagram' | 'pinterest' | 'vk' | 'rss' | 'flickr' | 'bitbucket' | 'linkedin' | 'tabler';
...
export type DisplayTypes = 'none' | 'inline' | 'inline-block' | 'block' | 'grid' | 'table-cell' | 'table-row' | 'flex' | 'inline-flex' | 'table';
